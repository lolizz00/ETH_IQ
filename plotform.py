...
class Ui_Plot(object):
    def setupUi(self, Plot):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 120, 27))
        ...
        self.minusPushButton.setEnabled(False)
        ...
        self.plusPushButton.setEnabled(False)
        ...
        self.clearPushButton.setGeometry(QtCore.QRect(30, 60, 75, 23))
        self.clearPushButton.setObjectName("clearPushButton")
        self.label = QtWidgets.QLabel(self.controlGroupBox)
        self.label.setGeometry(QtCore.QRect(190, 20, 521, 71))
    ...
    def retranslateUi(self, Plot):
        ...
        self.label.setText(_translate("Plot", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Для пользовательского масштабирования нажимите </span><img src=\"help.png\"/><span style=\" font-weight:600;\"> и</span></p><p align=\"center\"><span style=\" font-weight:600;\">удерживайте правую кнопку мыши, двигая паралельно масштабируемой оси. </span></p><p align=\"center\"><br/></p></body></html>"))
