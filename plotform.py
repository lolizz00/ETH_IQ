...
class Ui_Plot(object):
    def setupUi(self, Plot):
        ...
        self.widget.setGeometry(QtCore.QRect(70, 20, 120, 27))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.leftPushButton = QtWidgets.QPushButton(self.widget)
        ...
        self.rightPushButton = QtWidgets.QPushButton(self.widget)
        ...
        self.minusPushButton = QtWidgets.QPushButton(self.widget)
        ...
        self.plusPushButton = QtWidgets.QPushButton(self.widget)
