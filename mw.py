...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(220, 10, 141, 61))
        ...
        self.snrModeRadioButton.setChecked(False)
        self.snrModeRadioButton.setObjectName("snrModeRadioButton")
        self.gridLayout_5.addWidget(self.snrModeRadioButton, 2, 0, 1, 1)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(10, 20, 231, 101))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.layoutWidget7)
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.specChan7checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan7checkBox.setChecked(False)
        self.specChan7checkBox.setObjectName("specChan7checkBox")
        self.gridLayout_7.addWidget(self.specChan7checkBox, 3, 1, 1, 1)
        self.specChan6checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan6checkBox.setChecked(False)
        self.specChan6checkBox.setObjectName("specChan6checkBox")
        self.gridLayout_7.addWidget(self.specChan6checkBox, 1, 1, 1, 1)
        self.specChan5checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan5checkBox.setChecked(False)
        self.specChan5checkBox.setObjectName("specChan5checkBox")
        self.gridLayout_7.addWidget(self.specChan5checkBox, 0, 1, 1, 1)
        self.specChan8checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan8checkBox.setChecked(False)
        self.specChan8checkBox.setObjectName("specChan8checkBox")
        self.gridLayout_7.addWidget(self.specChan8checkBox, 4, 1, 1, 1)
        self.specChan1checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan1checkBox.setChecked(True)
        self.specChan1checkBox.setObjectName("specChan1checkBox")
        self.gridLayout_7.addWidget(self.specChan1checkBox, 0, 0, 1, 1)
        self.specChan2checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan2checkBox.setChecked(False)
        self.specChan2checkBox.setObjectName("specChan2checkBox")
        self.gridLayout_7.addWidget(self.specChan2checkBox, 1, 0, 1, 1)
        self.specChan3checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        ...
        self.specChan4checkBox = QtWidgets.QCheckBox(self.layoutWidget7)
        self.specChan4checkBox.setChecked(False)
        self.specChan4checkBox.setObjectName("specChan4checkBox")
        self.gridLayout_7.addWidget(self.specChan4checkBox, 4, 0, 1, 1)
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.widget = QtWidgets.QWidget(self.tab_3)
        self.widget.setGeometry(QtCore.QRect(20, 30, 271, 71))
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(20, 20, 88, 22))
        ...
        self.chanComboBox = QtWidgets.QComboBox(self.layoutWidget8)
        ...
        self.widget1.setGeometry(QtCore.QRect(20, 50, 131, 31))
        ...
        self.SNR_fsLineEdit = QtWidgets.QLineEdit(self.widget1)
