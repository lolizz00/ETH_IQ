...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cntSpinBox.setProperty("value", 100000)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(30, 30, 152, 31))
        ...
        self.SNR_fsLineEdit = QtWidgets.QLineEdit(self.layoutWidget4)
        self.SNR_fsLineEdit.setObjectName("SNR_fsLineEdit")
        self.horizontalLayout_5.addWidget(self.SNR_fsLineEdit)
        self.fsComboBox = QtWidgets.QComboBox(self.layoutWidget4)
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(30, 80, 201, 136))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(20, 220, 263, 172))
        ...
        self.winComboBox = QtWidgets.QComboBox(self.layoutWidget6)
        self.winComboBox.setMinimumSize(QtCore.QSize(100, 0))
        self.winComboBox.setObjectName("winComboBox")
        self.winComboBox.addItem("")
        self.winComboBox.addItem("")
        self.winComboBox.addItem("")
        self.winComboBox.addItem("")
        self.gridLayout_3.addWidget(self.winComboBox, 3, 1, 1, 1)
        self.SNR_offsetLineEdit = QtWidgets.QLineEdit(self.layoutWidget6)
        ...
        self.SNR_checkBox = QtWidgets.QCheckBox(self.layoutWidget6)
        ...
        self.SNR_offsComboBox = QtWidgets.QComboBox(self.layoutWidget6)
        ...
        self.nullLineEdit = QtWidgets.QLineEdit(self.layoutWidget6)
        self.nullLineEdit.setObjectName("nullLineEdit")
        self.gridLayout_3.addWidget(self.nullLineEdit, 4, 1, 1, 1)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(300, 290, 153, 91))
        ...
        self.showSampleCheckBox = QtWidgets.QCheckBox(self.layoutWidget7)
        ...
        self.showSplineCheckBox = QtWidgets.QCheckBox(self.layoutWidget7)
        ...
        self.chanCheckBox = QtWidgets.QCheckBox(self.layoutWidget7)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(300, 110, 161, 81))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.layoutWidget_2)
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.fixXXMinlineEdit = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.fixXXMinlineEdit.setObjectName("fixXXMinlineEdit")
        self.gridLayout_7.addWidget(self.fixXXMinlineEdit, 1, 1, 1, 1)
        ...
        self.fixXXcheckBox = QtWidgets.QCheckBox(self.layoutWidget_2)
        self.fixXXcheckBox.setObjectName("fixXXcheckBox")
        self.gridLayout_7.addWidget(self.fixXXcheckBox, 0, 0, 1, 2)
        self.fixXXMaxlineEdit = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.fixXXMaxlineEdit.setObjectName("fixXXMaxlineEdit")
        self.gridLayout_7.addWidget(self.fixXXMaxlineEdit, 2, 1, 1, 1)
        self.layoutWidget8 = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget8.setGeometry(QtCore.QRect(300, 200, 161, 71))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.layoutWidget8)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.fixXcheckBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.fixXcheckBox.setObjectName("fixXcheckBox")
        self.gridLayout_4.addWidget(self.fixXcheckBox, 0, 0, 1, 2)
        self.label_16 = QtWidgets.QLabel(self.layoutWidget8)
        self.label_16.setObjectName("label_16")
        self.gridLayout_4.addWidget(self.label_16, 1, 0, 1, 1)
        self.fixXMinlineEdit = QtWidgets.QLineEdit(self.layoutWidget8)
        self.fixXMinlineEdit.setObjectName("fixXMinlineEdit")
        self.gridLayout_4.addWidget(self.fixXMinlineEdit, 1, 1, 1, 1)
        self.label_17 = QtWidgets.QLabel(self.layoutWidget8)
        self.label_17.setObjectName("label_17")
        self.gridLayout_4.addWidget(self.label_17, 2, 0, 1, 1)
        self.fixXMaxlineEdit = QtWidgets.QLineEdit(self.layoutWidget8)
        self.fixXMaxlineEdit.setObjectName("fixXMaxlineEdit")
        self.gridLayout_4.addWidget(self.fixXMaxlineEdit, 2, 1, 1, 1)
        self.layoutWidget9 = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget9.setGeometry(QtCore.QRect(310, 20, 141, 65))
        self.layoutWidget9.setObjectName("layoutWidget9")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.layoutWidget9)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.oscModeRadioButton = QtWidgets.QRadioButton(self.layoutWidget9)
        ...
        self.specModeRadioButton = QtWidgets.QRadioButton(self.layoutWidget9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Окно"))
        self.winComboBox.setItemText(0, _translate("MainWindow", "Bartlett window"))
        self.winComboBox.setItemText(1, _translate("MainWindow", "Blackman window"))
        self.winComboBox.setItemText(2, _translate("MainWindow", "Hamming window"))
        self.winComboBox.setItemText(3, _translate("MainWindow", "Hanning window"))
        ...
        self.nullLineEdit.setText(_translate("MainWindow", "0"))
        self.label_15.setText(_translate("MainWindow", "Принять за 0"))
        ...
        self.fixXXcheckBox.setText(_translate("MainWindow", "Зафиксировать ось X"))
        self.fixXcheckBox.setText(_translate("MainWindow", "Зафиксировать ось Y"))
