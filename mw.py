...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(160, 10, 191, 71))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.layoutWidget4)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.iqModeRadioButton = QtWidgets.QRadioButton(self.layoutWidget4)
        ...
        self.snrModeRadioButton = QtWidgets.QRadioButton(self.layoutWidget4)
        self.snrModeRadioButton.setChecked(True)
        self.snrModeRadioButton.setObjectName("snrModeRadioButton")
        self.gridLayout_5.addWidget(self.snrModeRadioButton, 0, 1, 1, 1)
        self.tabWidget = QtWidgets.QTabWidget(self.groupBox_3)
        self.tabWidget.setGeometry(QtCore.QRect(20, 90, 371, 201))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.layoutWidget5 = QtWidgets.QWidget(self.tab)
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 30, 171, 88))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.layoutWidget5)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.chan1checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan5checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan2checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan6checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan3checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan7checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan4checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.chan8checkBox = QtWidgets.QCheckBox(self.layoutWidget5)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(200, 60, 129, 42))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget6)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.showSampleCheckBox = QtWidgets.QCheckBox(self.layoutWidget6)
        ...
        self.showSplineCheckBox = QtWidgets.QCheckBox(self.layoutWidget6)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(10, 100, 205, 31))
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(10, 20, 301, 65))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.layoutWidget8)
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.specChan1checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan1checkBox.setChecked(False)
        self.specChan1checkBox.setObjectName("specChan1checkBox")
        self.gridLayout_7.addWidget(self.specChan1checkBox, 0, 0, 2, 1)
        self.specChan4checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan4checkBox.setChecked(False)
        self.specChan4checkBox.setObjectName("specChan4checkBox")
        self.gridLayout_7.addWidget(self.specChan4checkBox, 0, 1, 2, 2)
        self.specChan7checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan7checkBox.setChecked(False)
        self.specChan7checkBox.setObjectName("specChan7checkBox")
        self.gridLayout_7.addWidget(self.specChan7checkBox, 1, 2, 2, 1)
        self.specChan2checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan2checkBox.setChecked(False)
        self.specChan2checkBox.setObjectName("specChan2checkBox")
        self.gridLayout_7.addWidget(self.specChan2checkBox, 2, 0, 1, 1)
        self.specChan5checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan5checkBox.setChecked(False)
        self.specChan5checkBox.setObjectName("specChan5checkBox")
        self.gridLayout_7.addWidget(self.specChan5checkBox, 2, 1, 1, 1)
        self.specChan3checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan3checkBox.setChecked(False)
        self.specChan3checkBox.setObjectName("specChan3checkBox")
        self.gridLayout_7.addWidget(self.specChan3checkBox, 3, 0, 1, 1)
        self.specChan6checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan6checkBox.setChecked(False)
        self.specChan6checkBox.setObjectName("specChan6checkBox")
        self.gridLayout_7.addWidget(self.specChan6checkBox, 3, 1, 1, 1)
        self.specChan8checkBox = QtWidgets.QCheckBox(self.layoutWidget8)
        self.specChan8checkBox.setChecked(True)
        self.specChan8checkBox.setObjectName("specChan8checkBox")
        self.gridLayout_7.addWidget(self.specChan8checkBox, 3, 2, 1, 1)
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.widget = QtWidgets.QWidget(self.tab_3)
        self.widget.setGeometry(QtCore.QRect(20, 30, 281, 100))
        ...
        self.SNR_cntLineEdit = QtWidgets.QLineEdit(self.widget)
        self.SNR_cntLineEdit.setObjectName("SNR_cntLineEdit")
        self.gridLayout_3.addWidget(self.SNR_cntLineEdit, 2, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.widget)
        self.label_4.setObjectName("label_4")
        self.gridLayout_3.addWidget(self.label_4, 1, 2, 1, 1)
        self.SNR_chanComboBox = QtWidgets.QComboBox(self.widget)
        ...
        self.SNR_chanComboBox.addItem("")
        self.SNR_chanComboBox.addItem("")
        self.gridLayout_3.addWidget(self.SNR_chanComboBox, 0, 1, 1, 1)
        self.SNR_offsetLineEdit = QtWidgets.QLineEdit(self.widget)
        self.SNR_offsetLineEdit.setObjectName("SNR_offsetLineEdit")
        self.gridLayout_3.addWidget(self.SNR_offsetLineEdit, 1, 1, 1, 1)
        ...
        self.layoutWidget9.setGeometry(QtCore.QRect(20, 20, 88, 22))
        ...
        self.SNR_fsLineEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.SNR_fsLineEdit.setGeometry(QtCore.QRect(60, 50, 51, 20))
        self.SNR_fsLineEdit.setObjectName("SNR_fsLineEdit")
        self.label_13 = QtWidgets.QLabel(self.groupBox_3)
        self.label_13.setGeometry(QtCore.QRect(20, 50, 31, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.snrModeRadioButton.setText(_translate("MainWindow", "SNR"))
        ...
        self.fsLineEdit.setText(_translate("MainWindow", "15000"))
        self.specChan1checkBox.setText(_translate("MainWindow", "Канал 1"))
        self.specChan4checkBox.setText(_translate("MainWindow", "Канал 4"))
        self.specChan7checkBox.setText(_translate("MainWindow", "Канал 7"))
        self.specChan2checkBox.setText(_translate("MainWindow", "Канал 2"))
        self.specChan5checkBox.setText(_translate("MainWindow", "Канал 5"))
        self.specChan3checkBox.setText(_translate("MainWindow", "Канал 3"))
        self.specChan6checkBox.setText(_translate("MainWindow", "Канал 6"))
        self.specChan8checkBox.setText(_translate("MainWindow", "Канал 8"))
        ...
        self.label_14.setText(_translate("MainWindow", "Количество считываний"))
        self.SNR_cntLineEdit.setText(_translate("MainWindow", "3"))
        self.label_4.setText(_translate("MainWindow", "Гц"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "SNR"))
